...
%Длина сегмента выбирается случайным образом между двумя индексами iи j. 
%Это гарантирует, что алгоритм исследует широкий спектр решений.

%Обновленная SimulatedAnnealing функция остается такой же, 
%как и раньше, но OptimiseRoute теперь использует новую GenerateStateCandidateфункцию. 
